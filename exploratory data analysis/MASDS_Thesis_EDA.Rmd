...
# line plot of death rate for subset communities
...
ggplot(overall_trend, aes(x = date, y = daily_deaths)) +
  ...
  labs(title = "Overall Daily COVID-19 Deaths for all LA communities", 
...
ggplot(subset_overall_trend, aes(x = date, y = daily_deaths)) +
  geom_line(color = "blue") +
  labs(title = "Overall Daily COVID-19 Deaths across select LA Communities", 
       x = "Date", y = "Number of Deaths") +
  theme_bw()
...
ggplot(subset_community_trend, aes(x = date, y = daily_deaths, color = name)) +
  geom_line() +
  facet_wrap(~ name, scales = "free_y") +
  labs(title = "Daily COVID-19 Deaths across select LA Communities over time", 
       x = "Date", y = "Number of Deaths") +
  theme_bw()
```
...
tm_shape(avg_deaths_cont_cubic) +
  tm_polygons("death_per_100k_cubic", title = "death rate (cubic)") +
...
tm_shape(total_deaths_cont_cubic) +
  tm_polygons("total_deaths_cubic", title = "total deaths (cubic)") +
  tm_layout(frame = FALSE, legend.position = c("left", "bottom"))
```
...
tm_shape(pop_cont_cubic) +
  tm_polygons("death_per_100k_cubic", title = "population, death rate (cubic)") +
  tm_layout(frame = FALSE, legend.position = c("left", "bottom"))
```
```{r}
...
tm_shape(pop_cont_cubic) +
  tm_polygons("total_deaths_cubic", title = "population, total deaths (cubic)") +
  tm_layout(frame = FALSE, legend.position = c("left", "bottom"))
```
