---
title: "MASDS Thesis - Bayesian model all past data - Santa Monica"
author: "Lauren Huang"
date: "`r Sys.Date()`"
...
expected_intensity <- sapply(time_grid, function(t) {
  lambda_(params, t, event_times[event_times < t], segment_info, age_data_sm[-9])
})
...
bayes_6_3_santa_monica_plot <- ggplot(comparison_df, aes(x = date)) +
