---
title: "MASDS Thesis - Bayesian model all past data - Pomona"
author: "Lauren Huang"
date: "`r Sys.Date()`"
...
summary(covid_fit_age_multi) # converged at 34 iterations
```
...
expected_intensity <- sapply(time_grid, function(t) {
  lambda_(params, t, event_times[event_times < t], segment_info, age_data_p[-9])
})
...
bayes_6_3_pomona_plot <- ggplot(comparison_df, aes(x = date)) +
