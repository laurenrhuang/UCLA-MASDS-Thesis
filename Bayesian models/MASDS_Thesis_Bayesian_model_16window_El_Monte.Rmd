...
```{r}
# adjust to have each death incidence be its own row
...
summary(covid_fit_age_multi) # converged at 10 iterations
```
...
expected_intensity <- sapply(time_grid, function(t) {
  lambda_(params, t, event_times[event_times < t], age_data_em[-9])
})
...
bayes_6_3_age_el_monte_new <- ggplot(comparison_df, aes(x = date)) +
