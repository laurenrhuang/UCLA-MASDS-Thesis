---
title: "MASDS Thesis - MLE model - by year Little Armenia"
author: "Lauren Huang"
date: "`r Sys.Date()`"
output: pdf_document
---
...
```{r}
# get little armenia data
little_armenia <- community_data %>%
  filter(name == "Los Angeles - Little Armenia")

# split little armenia dates by year
little_armenia_by_year <- little_armenia %>%
  mutate(year = format(date, "%Y"))

little_armenia_2020 <- filter(little_armenia_by_year, year == "2020")
little_armenia_2021 <- filter(little_armenia_by_year, year == "2021")
little_armenia_2022 <- filter(little_armenia_by_year, year == "2022")

# convert dates to numeric time (days since the start of the data)
start_date_2020 <- min(little_armenia_2020$date, na.rm = TRUE)
little_armenia_2020 <- little_armenia_2020 %>% mutate(time = as.numeric(difftime(date, start_date_2020, units = "days")))

start_date_2021 <- min(little_armenia_2021$date, na.rm = TRUE)
little_armenia_2021 <- little_armenia_2021 %>% mutate(time = as.numeric(difftime(date, start_date_2021, units = "days")))

start_date_2022 <- min(little_armenia_2022$date, na.rm = TRUE)
little_armenia_2022 <- little_armenia_2022 %>% mutate(time = as.numeric(difftime(date, start_date_2022, units = "days")))
...
event_times_little_armenia_2020 <- little_armenia_2020 %>%
  group_by(name) %>%
  summarise(event_times = list(unlist(mapply(generate_event_times, time, incidence))))

event_times_little_armenia_2020 <- event_times_little_armenia_2020 %>% pull(event_times)
event_times_little_armenia_2020 <- sort(unlist(event_times_little_armenia_2020))
event_times_little_armenia_2020_unique <- unique(event_times_little_armenia_2020)
adj_event_times_little_armenia_2020 <- event_times_little_armenia_2020_unique + 
  seq(0, length(event_times_little_armenia_2020_unique) - 1) * 1e-5

# generate event times for 2021
event_times_little_armenia_2021 <- little_armenia_2021 %>%
  group_by(name) %>%
  summarise(event_times = list(unlist(mapply(generate_event_times, time, incidence))))

event_times_little_armenia_2021 <- event_times_little_armenia_2021 %>% pull(event_times)
event_times_little_armenia_2021 <- sort(unlist(event_times_little_armenia_2021))
event_times_little_armenia_2021_unique <- unique(event_times_little_armenia_2021)
adj_event_times_little_armenia_2021 <- event_times_little_armenia_2021_unique + 
  seq(0, length(event_times_little_armenia_2021_unique) - 1) * 1e-5

# generate event times for 2022
event_times_little_armenia_2022 <- little_armenia_2022 %>%
  group_by(name) %>%
  summarise(event_times = list(unlist(mapply(generate_event_times, time, incidence))))

event_times_little_armenia_2022 <- event_times_little_armenia_2022 %>% pull(event_times)
event_times_little_armenia_2022 <- sort(unlist(event_times_little_armenia_2022))
event_times_little_armenia_2022_unique <- unique(event_times_little_armenia_2022)
adj_event_times_little_armenia_2022 <- event_times_little_armenia_2022_unique + 
  seq(0, length(event_times_little_armenia_2022_unique) - 1) * 1e-5
```
...
get_age_distribution <- function(community_name) {
    if (community_name == "Little_Armenia") {
        return(age_data_la)
    } else {
...
event_times_list <- list(
  "2020" = adj_event_times_little_armenia_2020,
  "2021" = adj_event_times_little_armenia_2021,
  "2022" = adj_event_times_little_armenia_2022
)

age_dist_la <- age_data_la[-9] / sum(age_data_la[-9])
```
...
save_little_armenia_results <- function(results, community, filename = "result_community_mle_6_3_age_daily.txt") {
...
# if (file.exists("result_little_armenia_old.txt")) file.remove("result_little_armenia_old.txt")
# 
# # loops through years and estimates parameters
# for (year in years) {
#   cat("\n=== Processing Little Armenia", year, "===\n")
# 
...
# 
#   # save results
#   save_little_armenia_results(mle_age_results_daily, paste0("Little_Armenia_", year),
#                              filename = "result_little_armenia_old.txt")
# 
#   # summary
#   cat("\nCompleted Little Armenia", year, "with convergence", fit$convergence, "\n")
...
read_little_armenia_results <- function(filename = "result_little_armenia_old.txt") {
...
little_armenia_results <- read_little_armenia_results()

community_names <- names(little_armenia_results)

# create a data frame of all baselines
baseline_df <- data.frame(
  Community = community_names,
  Baseline = sapply(little_armenia_results, function(x) x$baseline)
)

# create a matrix of all excitation parameters
excitation_matrix <- t(sapply(little_armenia_results, function(x) x$excitation_params))
colnames(excitation_matrix) <- paste0("Excitation_", 1:6)

# combine all parameters into one data frame
full_little_armenia_results <- do.call(rbind, lapply(names(little_armenia_results), function(comm) {
  data.frame(
    Community = comm,
    Baseline = little_armenia_results[[comm]]$baseline,
    Age_Coeffs = I(list(little_armenia_results[[comm]]$age_coefficients)),
    Excitation = I(list(little_armenia_results[[comm]]$excitation_params)),
    Decay = I(list(little_armenia_results[[comm]]$decay_params)),
    LogLik = little_armenia_results[[comm]]$loglik
  )
}))

print(baseline_df)
print(excitation_matrix)
head(full_little_armenia_results)
```

```{r}
# list of all communities
little_armenia_data <- list(
  "Little_Armenia_2020" = list(
    df = little_armenia_2020,
    adj_times = adj_event_times_little_armenia_2020,
    age_data = age_data_la
  ),
  "Little_Armenia_2021" = list(
    df = little_armenia_2021,
    adj_times = adj_event_times_little_armenia_2021,
    age_data = age_data_la
  ),
  "Little_Armenia_2022" = list(
    df = little_armenia_2022,
    adj_times = adj_event_times_little_armenia_2022,
    age_data = age_data_la
  )
)
...
little_armenia_results <- read_little_armenia_results("result_little_armenia_old.txt")

# plot
all_little_armenia_plots <- generate_all_plots(little_armenia_results, 
                                                  little_armenia_data)

# plot by year
all_little_armenia_plots$Little_Armenia_2020$plot
all_little_armenia_plots$Little_Armenia_2021$plot
all_little_armenia_plots$Little_Armenia_2022$plot
...
little_armenia_metrics <- lapply(names(all_little_armenia_plots), function(year_key) {
  df <- all_little_armenia_plots[[year_key]]$data
...
metrics_little_armenia_1 <- do.call(rbind, little_armenia_metrics)
metrics_little_armenia_1
```

```{r}
residuals_list_1 <- list()

for (year_key in names(all_little_armenia_plots)) {
  df_year <- all_little_armenia_plots[[year_key]]$data
  residuals_df <- data.frame(
    date = df_year$date,
    year = as.numeric(gsub("Little_Armenia_", "", year_key)), # get the year number
...
residuals_plot_1 <- ggplot(all_residuals_df_1, aes(x = date, y = residual)) +
  ...
  labs(title = "Residuals in Little Armenia by year (all past data)",
       x = "Date",
       y = "Residuals") +
  theme_minimal()
...
for (year_key in names(all_little_armenia_plots)) {
  ...
  residuals_df <- data.frame(
    date = df_year$date,
    year = as.numeric(gsub("Little_Armenia_", "", year_key)),
    observed = df_year$observed,
    expected = df_year$expected,
    residual = df_year$observed - df_year$expected,
...
std_residuals_plot_1 <- ggplot(all_residuals_df_1, aes(x = date, y = std_residual)) +
  ...
  geom_hline(yintercept = 0, linetype = "dashed", color = "black", linewidth = 0.8) +
  facet_wrap(~ year, scales = "free_x", ncol = 2) +
  labs(title = "Standardized Residuals in Little Armenia by Year (all past data)",
       x = "Date",
...
```{r}
params_2020 <- c(
  little_armenia_results[["Little_Armenia_2020"]]$baseline,
  little_armenia_results[["Little_Armenia_2020"]]$age_coefficients,
  little_armenia_results[["Little_Armenia_2020"]]$excitation_params,
  little_armenia_results[["Little_Armenia_2020"]]$decay_params
)

# calculate Ogata rescaled times
z_vals_2020 <- compute_rescaled_times_1(
  adj_event_times_little_armenia_2020,
  params_2020,
  age_dist_la
)

# histogram
hist(z_vals_2020, breaks = 20, main = "Little Armenia 2020 Ogata rescaled inter-event times", 
     xlab = "z", freq = FALSE)
curve(dexp(x, rate = 1), add = TRUE, col = "blue", lwd = 2)

# QQ plot
qqplot(qexp(ppoints(length(z_vals_2020))), z_vals_2020,
       main = "Little Armenia 2020 QQ plot (Exp(1))",
...
```{r}
params_2021 <- c(
  little_armenia_results[["Little_Armenia_2021"]]$baseline,
  little_armenia_results[["Little_Armenia_2021"]]$age_coefficients,
  little_armenia_results[["Little_Armenia_2021"]]$excitation_params,
  little_armenia_results[["Little_Armenia_2021"]]$decay_params
)

# calculate Ogata rescaled times
z_vals_2021 <- compute_rescaled_times_1(
  adj_event_times_little_armenia_2021,
  params_2021,
  age_dist_la
)

# histogram
hist(z_vals_2021, breaks = 20, main = "Little Armenia 2021 Ogata rescaled inter-event times", 
     xlab = "z", freq = FALSE)
curve(dexp(x, rate = 1), add = TRUE, col = "blue", lwd = 2)

# QQ plot
qqplot(qexp(ppoints(length(z_vals_2021))), z_vals_2021,
       main = "Little Armenia 2021 QQ plot (Exp(1))",
       xlab = "theoretical quantiles", ylab = "observed quantiles")
abline(0, 1, col = "red")
...
```{r}
params_2022 <- c(
  little_armenia_results[["Little_Armenia_2022"]]$baseline,
  little_armenia_results[["Little_Armenia_2022"]]$age_coefficients,
  little_armenia_results[["Little_Armenia_2022"]]$excitation_params,
  little_armenia_results[["Little_Armenia_2022"]]$decay_params
)

# calculate Ogata rescaled times
z_vals_2022 <- compute_rescaled_times_1(
  adj_event_times_little_armenia_2022,
  params_2022,
  age_dist_la
)

# histogram
hist(z_vals_2022, breaks = 20, main = "Little Armenia 2022 Ogata rescaled inter-event times", 
     xlab = "z", freq = FALSE)
curve(dexp(x, rate = 1), add = TRUE, col = "blue", lwd = 2)

# QQ plot
qqplot(qexp(ppoints(length(z_vals_2022))), z_vals_2022,
       main = "Little Armenia 2022 QQ plot (Exp(1))",
       xlab = "theoretical quantiles", ylab = "observed quantiles")
abline(0, 1, col = "red")
...
ggplot(median_residuals_df_1, aes(x = median_residual)) +
  ...
  labs(title = "Histogram of median residuals Little Armenia by year (all past data)",
...
```{r}
# 2020
std_res_2020 <- all_residuals_df_1 %>%
  filter(year == 2020) %>%
  pull(std_residual)

hist(std_res_2020, breaks = 20, probability = TRUE,
     main = "Little Armenia 2020 Standardized Residuals",
     xlab = "standardized residuals")
curve(dnorm(x, mean = 0, sd = 1), col = "blue", lwd = 2, add = TRUE)

qqnorm(std_res_2020, main = "Little Armenia 2020 QQ Plot Standardized Residuals (Normal)")
qqline(std_res_2020, col = "red")

ks.test(std_res_2020, "pnorm", mean = 0, sd = 1)

# 2021
std_res_2021 <- all_residuals_df_1 %>%
  filter(year == 2021) %>%
  pull(std_residual)

hist(std_res_2021, breaks = 20, probability = TRUE,
     main = "Little Armenia 2021 Standardized Residuals",
     xlab = "standardized residuals")
curve(dnorm(x, mean = 0, sd = 1), col = "blue", lwd = 2, add = TRUE)

qqnorm(std_res_2021, main = "Little Armenia 2021 QQ Plot Standardized Residuals (Normal)")
qqline(std_res_2021, col = "red")

ks.test(std_res_2021, "pnorm", mean = 0, sd = 1)

# 2022
std_res_2022 <- all_residuals_df_1 %>%
  filter(year == 2022) %>%
  pull(std_residual)

hist(std_res_2022, breaks = 20, probability = TRUE,
     main = "Little Armenia 2022 Standardized Residuals",
     xlab = "standardized residuals")
curve(dnorm(x, mean = 0, sd = 1), col = "blue", lwd = 2, add = TRUE)

qqnorm(std_res_2022, main = "Little Armenia 2022 QQ Plot Standardized Residuals (Normal)")
qqline(std_res_2022, col = "red")

ks.test(std_res_2022, "pnorm", mean = 0, sd = 1)
```
...
log_likelihood <- function(p, year, lambda = 0.01) {
    ...
    # age distribution
    age_data <- get_age_distribution("Little_Armenia")[1:8]
...
fit_little_armenia_by_year <- function(year) {
    df_name <- paste0("little_armenia_", year)
...
result_little_armenia <- matrix(0, ncol = 18, nrow = 3)

# clear file to start fresh before appending new results
# sink("result_little_armenia.txt")
# sink()
# for (m in 1:3) {
#     result_little_armenia[m,] = fit_little_armenia_by_year(years[m])
#     # append to file
#     sink("result_little_armenia.txt", append=T)
#     cat(m, " ", result_little_armenia[m,], "\n")
#     sink()
# }

x1 = scan("C:/Users/cupca/Desktop/UCLA/Thesis/result_little_armenia.txt") 
x2 <- matrix(x1, ncol = 19, nrow = 3, byrow = TRUE)
result_little_armenia <- x2[1:3, 2:19]
result_little_armenia_coefficients <- result_little_armenia[, 11:18]
```

```{r, warning = F}
# function for calculating expected deaths
compute_expected_deaths_little_armenia <- function(params, df, community_name) {
    mu <- params[1]
...
for (m in 1:3) {
    ...
    df_name <- paste0("little_armenia_", year)
    df <- get(df_name, envir = .GlobalEnv)
    params <- result_little_armenia[m, ]
    expected_deaths <- compute_expected_deaths_little_armenia(params, 
                                                            df, 
                                                            community_name = "Little_Armenia")
...
for (m in 1:3) {
    ...
    expected_deaths <- compute_expected_deaths_little_armenia(params, df, community_name = "Little_Armenia")
    ...
    p <- ggplot(df, aes(x = date)) +
      ...
      geom_line(aes(y = expected, color = "Expected"), linewidth = 1) +
      scale_color_manual(values = c("red", "black")) +
      labs(title = paste("Expected vs. Observed Deaths for Little Armenia", year),
...
for (m in seq_along(years)) {
  year <- years[m]
  df <- get(paste0("little_armenia_", year))
  
  expected_deaths <- compute_expected_deaths_little_armenia(result_little_armenia[m, ], df, "Little_Armenia")
...
metrics_little_armenia_2 <- do.call(rbind, metrics_list)
metrics_little_armenia_2
```

```{r}
year_dfs <- list(
  `2020` = little_armenia_2020,
  `2021` = little_armenia_2021,
  `2022` = little_armenia_2022
)
...
for (y in 1:length(year_dfs)) {
    ...
    df_year <- year_dfs[[y]]
    expected_deaths <- compute_expected_deaths_little_armenia(result_little_armenia[y, ], 
                                                            df_year, "Little_Armenia")
...
residuals_plot_2 <- ggplot(all_residuals_df_2, aes(x = date, y = residual)) +
  ...
  geom_hline(yintercept = 0, linetype = "dashed", color = "black", linewidth = 0.8) +
  facet_wrap(~ year, scales = "free_x", ncol = 2) +
  labs(title = "Residuals in Little Armenia by year (16 day window approach)",
       x = "Date",
       y = "Residuals") +
  theme_minimal()
...
std_residuals_plot_2 <- ggplot(all_residuals_df_2, aes(x = date, y = std_residual)) +
  ...
  geom_hline(yintercept = 0, linetype = "dashed", color = "black", linewidth = 0.8) +
  facet_wrap(~ year, scales = "free_x", ncol = 2) +
  labs(title = "Standardized Residuals in Little Armenia by Year (16-day rolling window)",
       x = "Date",
       y = "Standardized Residuals") +
  theme_minimal()
...
```{r}
# compute Ogata rescaled inter-event times
compute_rescaled_times_2 <- function(df, params, community_name = "Little_Armenia") {
  mu <- params[1] 
  K <- params[2:7]
...
```{r}
df_2020 <- little_armenia_2020
params_2020 <- result_little_armenia[1, ]
...
hist(z_vals_2020, breaks = 20, probability = TRUE, 
     main = "Little Armenia 2020 Ogata rescaled inter-event times",
...
```{r}
df_2021 <- little_armenia_2021
params_2021 <- result_little_armenia[1, ]
...
hist(z_vals_2021, breaks = 20, probability = TRUE, 
     main = "Little Armenia 2021 Ogata rescaled inter-event times",
     xlab = "z (rescaled time)")
curve(dexp(x, rate = 1), add = TRUE, col = "blue", lwd = 2)
...
```{r}
df_2022 <- little_armenia_2022
params_2022 <- result_little_armenia[1, ]
...
hist(z_vals_2022, breaks = 20, probability = TRUE, 
     main = "Little Armenia 2022 Ogata rescaled inter-event time",
     xlab = "z (rescaled time)")
curve(dexp(x, rate = 1), add = TRUE, col = "blue", lwd = 2)
...
ggplot(median_residuals_df_2, aes(x = median_residual)) +
  geom_histogram(bins = 30, fill = "lightblue", color = "black") +
  geom_vline(xintercept = 0, linetype = "dashed", color = "red", linewidth = 0.8) +
  labs(title = "Histogram of median residuals Little Armenia by year (16-day rolling window)",
       x = "median daily residual",
       y = "frequency") +
  facet_wrap(~ year, ncol = 2) +
  theme_minimal()
...
```{r}
# 2020
std_res_2020 <- all_residuals_df_2 %>%
  filter(year == 2020) %>%
  pull(std_residual)
...
qqnorm(std_res_2020,
       main = "Little Armenia 2020 QQ Plot Standardized Residuals (Normal)")
qqline(std_res_2020, col = "red")

ks.test(std_res_2020, "pnorm", mean = 0, sd = 1)

# 2021
std_res_2021 <- all_residuals_df_2 %>%
  filter(year == 2021) %>%
  pull(std_residual)
...
qqnorm(std_res_2021,
       main = "Little Armenia 2021 QQ Plot Standardized Residuals (Normal)")
qqline(std_res_2021, col = "red")

ks.test(std_res_2021, "pnorm", mean = 0, sd = 1)

# 2022
std_res_2022 <- all_residuals_df_2 %>%
  filter(year == 2022) %>%
  pull(std_residual)
...
qqnorm(std_res_2022,
       main = "Little Armenia 2022 QQ Plot Standardized Residuals (Normal)")
qqline(std_res_2020, col = "red")
