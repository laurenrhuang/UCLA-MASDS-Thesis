---
title: "MASDS Thesis - MLE model - by year Santa Monica"
author: "Lauren Huang"
date: "`r Sys.Date()`"
output: pdf_document
---
...
hist(std_res_2020, breaks = 20, probability = TRUE,
     main = "Santa Monica 2020 Standardized Residuals",
     xlab = "standardized residuals")
curve(dnorm(x, mean = 0, sd = 1), col = "blue", lwd = 2, add = TRUE)

qqnorm(std_res_2020, main = "Santa Monica 2020 QQ Plot Standardized Residuals (Normal)")
...
hist(std_res_2021, breaks = 20, probability = TRUE,
     main = "Santa Monica 2021 Standardized Residuals",
     xlab = "standardized residuals")
curve(dnorm(x, mean = 0, sd = 1), col = "blue", lwd = 2, add = TRUE)

qqnorm(std_res_2021, main = "Santa Monica 2021 QQ Plot Standardized Residuals (Normal)")
...
hist(std_res_2022, breaks = 20, probability = TRUE,
     main = "Santa Monica 2022 Standardized Residuals",
     xlab = "standardized residuals")
curve(dnorm(x, mean = 0, sd = 1), col = "blue", lwd = 2, add = TRUE)

qqnorm(std_res_2022, main = "Santa Monica 2022 QQ Plot Standardized Residuals (Normal)")
...
std_residuals_plot_2 <- ggplot(all_residuals_df_2, aes(x = date, y = std_residual)) +
  ...
  geom_hline(yintercept = 0, linetype = "dashed", color = "black", linewidth = 0.8) +
  facet_wrap(~ year, scales = "free_x", ncol = 2) +
  labs(title = "Standardized Residuals in Santa Monica by Year (16-day rolling window)",
       x = "Date",
       y = "Standardized Residuals") +
  theme_minimal()
...
qqnorm(std_res_2020,
       main = "Santa Monica 2020 QQ Plot Standardized Residuals (Normal)")
qqline(std_res_2020, col = "red")
...
qqnorm(std_res_2021,
       main = "Santa Monica 2021 QQ Plot Standardized Residuals (Normal)")
qqline(std_res_2021, col = "red")
...
qqnorm(std_res_2022,
       main = "Santa Monica 2022 QQ Plot Standardized Residuals (Normal)")
qqline(std_res_2020, col = "red")
